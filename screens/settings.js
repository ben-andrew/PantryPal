        ...
        <View style={styles.recipeContainer}>
            ...
            {["Ingredient Settings", "Recipe Settings", "Setting 4"].map((settings, index) => (
                ...
                {settings === "Recipe Settings" && (
                    <>
                    <Image source = {require('../assets/recipesettings.png')} style={styles.recipesettingsImage} />
                    <Text style={styles.settingsText}>{settings}</Text>
                ...
                {settings === "Ingredient Settings" && (
                    <>
                    <Image source = {require('../assets/ingredientsettings.png')} style={styles.ingredientsettingsImage} />
                    <Text style={styles.settingsText}>{settings}</Text>
